...
from .views import CitacionListView, CitacionCreateView, CitacionGrupoCreateView, CitacionDetailView, CitacionVistoView, CitacionTutorListView, CitacionAnularView
...
urlpatterns = [
    ...
    path("citaciones/crear-grupo/", CitacionGrupoCreateView.as_view(), name="citacion-grupo-create"),
