...
urlpatterns = [
    ...
    path('director/citaciones/',    views.director_citaciones_view,       name='director-citaciones'),
    ...
    path('director/calificaciones/', views.director_ver_calificaciones_view, name='director-ver-calificaciones'),
