...
from backend.apps.students.services import importar_estudiantes_desde_excel
...
class ImportarEstudiantesExcelView(APIView):
    ...
    def post(self, request):
        ...
        if Estudiante.objects.exists():
            return Response(
                {"errores": "Ya existen estudiantes registrados. La importación por Excel solo está disponible una vez."},
